...
window.ITINERARY_DATA = [
  ...
  },
  {
    ...
    briefing: {
      title: "ก่อนเข้า Shanghai Disneyland",
      intro:
        "อ่านรอบเดียวก่อนออกจากโรงแรม — ตั๋ว การเข้าสวน การจ่ายเงิน และคำศัพท์ที่จะเจอในการ์ดเครื่องเล่นด้านล่าง",
      points: [
        {
          label: "ตั๋ว",
        ...
        {
          label: "แอปที่ต้องมี",
          text: "โหลด Shanghai Disney Resort ก่อนไป ใช้ดูเวลารอแบบเรียลไทม์ รอบโชว์ แผนที่ สั่งอาหาร และซื้อบัตรลัดคิว — สวนนี้แทบทุกอย่างอยู่ในแอป"
        },
        {
          label: "ไปถึงกี่โมง",
        ...
        {
          label: "บัตรลัดคิว (Premier Access)",
          text: "เสียเงินเพิ่ม ซื้อในแอปเป็นรายเครื่องเล่น ราคาต่างกันตามวันและความฮิต ถ้ามีวันเดียวและอยากเล่น TRON กับ Soaring ให้แน่ๆ ถือว่าคุ้ม"
        },
        {
          label: "จ่ายเงิน",
    ...
    items: [
      ...
      },
      {
        ...
        park: {
          story:
            "รวมทุกโชว์ในสวนไว้ที่เดียว มีทั้งหมด 6 รายการ: ขบวนพาเหรด 1 + โชว์ 5 (โชว์ปราสาทกลางวัน, โชว์ปิดสวนตอนกลางคืน และโชว์ในโรงละครอีก 3 ที่อยู่ในโซนของตัวเอง) อยู่ล่างสุดเพราะเรียงตามเวลาไม่ใช่ความฮิต — วางแผนเครื่องเล่นรอบๆ เวลาโชว์จะง่ายที่สุด",
          characters: ["mickey"],
          tip:
